...
class S {
  ...
  String get uebungsbereiche => _t(
      'Übungsbereiche', 'Разделы упражнений', 'Розділи вправ', 'Practice sections');
  String get muendlichePruefung => _t(
      'Mündliche Prüfung', 'Устный экзамен', 'Усний іспит', 'Oral exam');
  String get eigenesPdf =>
      _t('EIGENES PDF', 'СВОЙ PDF', 'СВІЙ PDF', 'OWN PDF');
  ...
  String get pdfImportieren =>
      _t('PDF importieren', 'Импортировать PDF', 'Імпортувати PDF', 'Import PDF');
  String get pruefungWaehlen => _t(
      'Prüfung wählen', 'Выбор экзамена', 'Вибір іспиту', 'Choose Exam');
  ...
  String get kursLoeschenTitel => _t(
      'Kurs löschen?', 'Удалить курс?', 'Видалити курс?', 'Delete course?');
  String get abbrechen => _t('Abbrechen', 'Отмена', 'Скасувати', 'Cancel');
  String get loeschen => _t('Löschen', 'Удалить', 'Видалити', 'Delete');
  String get premiumKonto =>
      _t('Premium-Konto', 'Премиум-аккаунт', 'Преміум-акаунт', 'Premium account');
  ...
  String get kontoLoeschen =>
      _t('Konto löschen', 'Удалить аккаунт', 'Видалити акаунт', 'Delete account');
  ...
  String get kontoEndgueltigLoeschen => _t(
      'Endgültig löschen', 'Удалить навсегда', 'Видалити назавжди', 'Delete permanently');
  String get kontoWirdGeloescht => _t(
      'Konto wird gelöscht …', 'Удаление аккаунта …', 'Видалення акаунта …',
      'Deleting account …');
  String get kontoLoeschenFehlerTitel => _t(
      'Löschen fehlgeschlagen', 'Не удалось удалить', 'Не вдалося видалити',
      'Deletion failed');
  ...
  String get gespeicherteUebungen => _t('Gespeicherte Übungen',
      'Сохранённые упражнения', 'Збережені вправи', 'Saved exercises');
  String get keineLesezeichen => _t(
      'Keine Lesezeichen', 'Нет закладок', 'Немає закладок', 'No bookmarks');
  ...
  String get lesezeichenGespeichert => _t('Lesezeichen gespeichert',
      'Добавлено в закладки', 'Додано до закладок', 'Bookmark saved');
  String get lesezeichenEntfernt => _t('Lesezeichen entfernt',
      'Удалено из закладок', 'Видалено із закладок', 'Bookmark removed');
  String get lesezeichenEntfernen => _t('Lesezeichen entfernen',
      'Удалить закладку', 'Видалити закладку', 'Remove bookmark');
  String get lesezeichenHinzufuegen => _t('Lesezeichen hinzufügen',
      'Добавить закладку', 'Додати закладку', 'Add bookmark');

  // ── Probeprüfung (mock exam) ──────────────────────────────────────────
  String get pruefungssimulation => _t(
      'Prüfungssimulation', 'Пробный экзамен', 'Пробний іспит', 'Mock Exam');
  String get neueAufgabenWaehlen => _t('Neue Aufgaben wählen',
      'Выбрать новые задания', 'Обрати нові завдання', 'Pick new tasks');
  ...
  // ── Login ────────────────────────────────────────────────────────────────
  String get kontoErstellen =>
      _t('Konto erstellen', 'Создайте аккаунт', 'Створіть акаунт', 'Create an account');
  String get zumFortfahrenAnmelden => _t(
      'Zum Fortfahren anmelden',
      'Войдите, чтобы продолжить',
      'Увійдіть, щоб продовжити',
      'Sign in to continue');
  String get mitGoogleAnmelden =>
      _t('Mit Google anmelden', 'Войти через Google', 'Увійти через Google', 'Sign in with Google');
  ...
  String get ungueltigeEmail =>
      _t('Ungültige E-Mail.', 'Некорректный email.', 'Некоректний email.', 'Invalid email.');
  ...
  String get anmeldefehler =>
      _t('Anmeldefehler.', 'Ошибка авторизации.', 'Помилка авторизації.', 'Sign-in error.');

  // ── Import ───────────────────────────────────────────────────────────────
  String get importPdf => _t('PDF importieren', 'Импорт PDF', 'Імпорт PDF', 'Import PDF');
  ...
  String get pdfWaehlen => _t('PDF wählen', 'Выбрать PDF', 'Вибрати PDF', 'Choose PDF');
  ...
  String get pdfKonvertierung =>
      _t('PDF wird konvertiert…', 'Конвертация PDF…', 'Конвертація PDF…', 'Converting PDF…');
  String get cachePruefung =>
      _t('Cache wird geprüft…', 'Проверка кеша…', 'Перевірка кешу…', 'Checking cache…');
  ...
  String get speichern => _t('Wird gespeichert…', 'Сохранение…', 'Збереження…', 'Saving…');
  ...
  String get kursNichtGefunden => _t(
      'Kurs nicht gefunden', 'Курс не найден', 'Курс не знайдено', 'Course not found');
  ...
  String get varianteWaehlen =>
      _t('Variante wählen', 'Выберите вариант', 'Виберіть варіант', 'Choose a variant');
  String variante(num n) => _t(
      'Variante $n', 'Вариант $n', 'Варіант $n', 'Variant $n');
  String varianteMitVersion(num n, String version) => _t(
      'Variante $n · $version', 'Вариант $n · $version',
      'Варіант $n · $version', 'Variant $n · $version');
  ...
  String get antwortenZeigen => _t(
      'Antworten zeigen', 'Показать ответы', 'Показати відповіді', 'Show answers');
  ...
  String vonRichtig(int correct, int total) => _t(
      '$correct von $total richtig', '$correct из $total правильно',
      '$correct з $total правильно', '$correct out of $total correct');
  String aufgabeNummer(int n) =>
      _t('Aufgabe $n', 'Задание $n', 'Завдання $n', 'Task $n');

  // ── Telefonnotiz ─────────────────────────────────────────────────────────
  String telefonnotizVariante(num n) => _t(
      'Telefonnotiz · Variante $n', 'Telefonnotiz · Вариант $n',
      'Telefonnotiz · Варіант $n', 'Telefonnotiz · Variant $n');
  String get aufnahmeAnhoeren =>
      _t('Aufnahme anhören', 'Слушать запись', 'Слухати запис', 'Listen to recording');
  String get anrufTyp => _t('Art des Anrufs', 'Тип звонка', 'Тип дзвінка', 'Call type');
  String get name => _t('Name', 'Имя', "Ім'я", 'Name');
  String get telefon => _t('Telefon', 'Телефон', 'Телефон', 'Phone');
  String get zuErledigen => _t('Zu erledigen', 'К исполнению', 'До виконання', 'To do');
  ...
  // ── Beschwerde ───────────────────────────────────────────────────────────
  String get internerHinweis =>
      _t('INTERNER HINWEIS', 'ВНУТРЕННЯЯ ЗАПИСКА', 'ВНУТРІШНЯ ЗАПИСКА', 'INTERNAL NOTE');
  String get kundenbeschwerde =>
      _t('KUNDENBESCHWERDE', 'ЖАЛОБА КЛИЕНТА', 'СКАРГА КЛІЄНТА', 'CUSTOMER COMPLAINT');
  String get antwortbogen =>
      _t('ANTWORTBOGEN', 'БЛАНК ОТВЕТА', 'БЛАНК ВІДПОВІДІ', 'ANSWER SHEET');
  String woerterCount(int count, int max) => _t(
      'Wörter: $count / $max', 'Слов: $count / $max',
      'Слів: $count / $max', 'Words: $count / $max');
  ...
  String get fragenZuDenTexten =>
      _t('FRAGEN ZU DEN TEXTEN', 'ВОПРОСЫ К ТЕКСТАМ', 'ПИТАННЯ ДО ТЕКСТІВ', 'QUESTIONS ON THE TEXTS');
  ...
  String instruktion(String sectionType) => switch (sectionType) {
        ...
        _ => _t('Lösen Sie die Aufgaben.', 'Выполните задания.',
            'Виконайте завдання.', 'Solve the tasks.'),
      };
  String get transkript => _t('Transkript', 'Транскрипт', 'Транскрипт', 'Transcript');
  String get texteLesen =>
      _t('Texte lesen', 'Читать тексты', 'Читати тексти', 'Read texts');
  String get text => _t('Text', 'Текст', 'Текст', 'Text');
  String get aussagen => _t('AUSSAGEN', 'УТВЕРЖДЕНИЯ', 'ТВЕРДЖЕННЯ', 'STATEMENTS');
  String get aufgaben => _t('Aufgaben', 'Задания', 'Завдання', 'Tasks');
  String get ausgezeichnetAllesRichtig => _t(
      'Ausgezeichnet! Alles richtig!', 'Отлично! Всё правильно!',
      'Чудово! Все правильно!', 'Excellent! All correct!');
  ...
  String get niveauWaehlen =>
      _t('Niveau wählen', 'Выберите уровень', 'Виберіть рівень', 'Choose a level');
  String teileThemen(int teile, int themen) => _t(
      '$teile Teile · $themen Themen', '$teile части · $themen тем',
      '$teile частини · $themen тем', '$teile parts · $themen topics');
  ...
  String get uebungstypWaehlen => _t(
      'Wählen Sie einen Übungstyp:', 'Выберите тип упражнения:',
      'Виберіть тип вправи:', 'Choose an exercise type:');
  ...
  String get monolog2Minuten => _t(
      'Monolog · 2 Minuten', 'Монолог · 2 минуты', 'Монолог · 2 хвилини', 'Monologue · 2 minutes');
  ...
  String get loesungswegeDiskutieren => _t(
      'Lösungswege diskutieren', 'Обсуждение путей решения',
      'Обговорення шляхів вирішення', 'Discuss solutions');
  String get smalltalkDialog =>
      _t('Smalltalk · Dialog', 'Смолток · диалог', 'Смолток · діалог', 'Small talk · dialogue');
  String get redemittel =>
      _t('REDEMITTEL', 'РЕЧЕВЫЕ ОБОРОТЫ', 'МОВЛЕННЄВІ ЗВОРОТИ', 'USEFUL PHRASES');
  String get aufgabeLabel => _t('AUFGABE', 'ЗАДАНИЕ', 'ЗАВДАННЯ', 'TASK');
  String get redezeit => _t('REDEZEIT', 'ВРЕМЯ НА ОТВЕТ', 'ЧАС НА ВІДПОВІДЬ', 'SPEAKING TIME');
  String get zeitAbgelaufenAusruf => _t(
      'Zeit abgelaufen!', 'Время истекло!', 'Час вийшов!', 'Time is up!');
  ...
  // ── Smalltalk exercise ──
  String get gespraechspartnerSagt => _t('Ihr Gesprächspartner sagt:',
      'Ваш собеседник говорит:', 'Ваш співрозмовник каже:',
  ...
  String get beispieldialog =>
      _t('BEISPIELDIALOG', 'ПРИМЕР ДИАЛОГА', 'ПРИКЛАД ДІАЛОГУ', 'SAMPLE DIALOGUE');
  String get alternativsaetze =>
      _t('ALTERNATIVSÄTZE', 'АЛЬТЕРНАТИВНЫЕ ФРАЗЫ', 'АЛЬТЕРНАТИВНІ ФРАЗИ', 'ALTERNATIVE PHRASES');
  ...
  String situationVon(int n, int total) => _t(
      'Situation $n von $total', 'Ситуация $n из $total',
      'Ситуація $n з $total', 'Situation $n of $total');
  String get diskussionspunkte => _t(
      'Diskussionspunkte', 'Пункты для обсуждения', 'Пункти для обговорення',
      'Discussion points');
  String get beispieldialogTitel =>
      _t('Beispieldialog', 'Пример диалога', 'Приклад діалогу', 'Sample dialogue');
  String get redemittelTitel =>
      _t('Redemittel', 'Речевые обороты', 'Мовленнєві звороти', 'Useful phrases');

  // ── Legal: link labels / consent ──────────────────────────────────────────
  String get datenschutz =>
      _t('Datenschutz', 'Конфиденциальность', 'Конфіденційність', 'Privacy');
  String get datenschutzerklaerung => _t('Datenschutzerklärung',
  ...
  String get nutzungsbedingungen => _t('Nutzungsbedingungen',
  ...
  String get impressumAngabenBody => _t(
      ...
      'Ihor Bondarenko\nУкраїна\nE-Mail: linguaproapps@gmail.com',
      'Ihor Bondarenko\nUkraine\nE-Mail: linguaproapps@gmail.com');
  String get impressumVerantwortlich => _t('Verantwortlich für den Inhalt',
      'Ответственный за содержание', 'Відповідальний за зміст',
      'Responsible for Content');
  String get impressumHaftung => _t('Haftungsausschluss',
      'Отказ от ответственности', 'Відмова від відповідальності', 'Disclaimer');
  ...
  // ── Privacy Policy ────────────────────────────────────────────────────────
  String get datenschutzTitel => _t('Datenschutzerklärung',
      'Политика конфиденциальности', 'Політика конфіденційності',
      'Privacy Policy');
  String get datenschutz1 =>
      _t('1. Verantwortlicher', '1. Ответственный', '1. Відповідальний',
          '1. Controller');
  String get datenschutz1Body => _t(
      ...
      'Ihor Bondarenko, Ukraine\nE-Mail: linguaproapps@gmail.com');
  String get datenschutz2 => _t('2. Welche Daten wir erheben',
      '2. Какие данные мы собираем', '2. Які дані ми збираємо',
      '2. Data We Collect');
  ...
  String get datenschutz3 => _t('3. Zweck der Datenverarbeitung',
      '3. Цель обработки данных', '3. Мета обробки даних',
  ...
  String get datenschutz4 => _t('4. Drittanbieter', '4. Сторонние сервисы',
      '4. Сторонні сервіси', '4. Third-Party Services');
  ...
  String get datenschutz5 => _t('5. Datenweitergabe', '5. Передача данных',
      '5. Передача даних', '5. Data Sharing');
  String get datenschutz5Body => _t(
      ...
      'functionality.');
  String get datenschutz6 => _t('6. Datenspeicherung', '6. Хранение данных',
      '6. Зберігання даних', '6. Data Storage');
  ...
  String get datenschutz7 => _t('7. Deine Rechte (DSGVO)',
      '7. Ваши права (GDPR)', '7. Ваші права (GDPR)', '7. Your Rights (GDPR)');
  ...
  // ── Terms of Use ──────────────────────────────────────────────────────────
  String get nutzungTitel => _t('Nutzungsbedingungen',
      'Условия использования', 'Умови використання', 'Terms of Use');
  String get nutzung1 => _t('1. Geltungsbereich', '1. Область применения',
  ...
  String get nutzung2 => _t('2. Leistungsbeschreibung', '2. Описание сервиса',
      '2. Опис сервісу', '2. Service Description');
  ...
  String get nutzung3 => _t('3. Deine Inhalte und Verantwortung',
  ...
  String get nutzung3Body => _t(
      ...
      'is prohibited.');
  String get nutzung4 => _t('4. KI-Hinweis', '4. Примечание об ИИ',
      '4. Примітка про ШІ', '4. AI Notice');
  ...
  String get nutzung5 => _t('5. Verfügbarkeit und Haftung',
  ...
  String get nutzung6 => _t('6. Sperrung und Kündigung',
      '6. Блокировка и прекращение', '6. Блокування та припинення',
